...
__Problem Statement 4)__ 1.SO2 is Considered to be harmful of health.
		      So which wine is most harmful for your health? 
		      Provide rank on the degree of harmfulness of wines and plot a graph for SO2 vs Quality.


		      2.Find the correlation between residual sugar vs total sulphur dioxide.
		      Plot three scatter plots for quality range (3, 4), (5, 6), (7, 8).
		      
__Fact__: Sweet white wines typically contain the most sulphites, as more is added to halt the fermentation process.Another reason why a night on the white might make that hangover worse than usual.
__Analysis__: Relation is directly proportional. Some medium and low-quality wines have high amounts of both contents.
